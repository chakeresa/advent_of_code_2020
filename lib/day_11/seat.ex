defmodule Seat do
  ...
  def equilibrium_occupied_seats(list_of_lines \\ @list_of_lines_from_txt) do
    ...
    |> count_of_occupied_seats()
  end

  def count_of_occupied_seats(list_of_lines) do
    list_of_lines
    |> Enum.map(fn row ->
      row
      |> String.graphemes()
  ...
  """
  def visible_equilibrium_occupied_seats(list_of_lines \\ @list_of_lines_from_txt) do
    list_of_lines
    |> visible_continue_until_equilibrium()
    |> count_of_occupied_seats()
  end
